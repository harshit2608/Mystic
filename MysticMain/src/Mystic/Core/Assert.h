...
#define MC_ASSERT(...) MC_EXPAND_MACRO(MC_INTERNAL_ASSERT_GET_MACRO(__VA_ARGS__)(_, __VA_ARGS__))
#define MC_CORE_ASSERT(...) MC_EXPAND_MACRO(MC_INTERNAL_ASSERT_GET_MACRO(__VA_ARGS__)(_CORE_, __VA_ARGS__))
#else
#define MC_ASSERT(...)
